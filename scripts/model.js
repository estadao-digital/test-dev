/**
 * backbone model definitions for CADASTRO DE CARROS
 */
 ...
 * Dado Backbone Model
 */
model.DadoModel = Backbone.Model.extend({
	urlRoot: 'api/dado',
	idAttribute: 'id',
	id: '',
	marca: '',
...
/**
 * Dado Backbone Collection
 */
model.DadoCollection = model.AbstractCollection.extend({
	url: 'api/dados',
	model: model.DadoModel
});
