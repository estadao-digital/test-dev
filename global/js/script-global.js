...
$(document).ready(function() {
    ...
    $(".boxes").click(function() {
		$(".listing").removeClass("select");
		$("#list-car").removeClass("list-listing");
		$(".boxes").addClass("select");
	});
    $(".listing").click(function() {
		$(".boxes").removeClass("select");
		$(".listing").addClass("select");
		$("#list-car").addClass("list-listing");
	});
