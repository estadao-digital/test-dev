...
<article class="lista-carros container">
	...
	<ul class="lista-conteudo">
		...
		<?php foreach ($dataJSON -> carrosJSON as $carro) : ?>
		<li class="lncarro" carro-id="<?php echo $carro->ID; ?>">
			<span>#<?php echo $carro->ID; ?></span>
			<span><?php echo $carro->Marca; ?></span>
			<span><?php echo $carro->Modelo; ?></span>
			<span><?php echo $carro->Ano; ?></span>
			<span>
				<div class="btn-action btn-edit" action="edit"></div>
				<div class="btn-action btn-del" action="del"></div>
			</span>
		</li>
		<?php endforeach; ?>
	</ul>
...
<div class="btn-cadastrar container">
	<span class="abrir">CADASTRAR NOVO CARRO</span>
</div>

<article class="cadastrar-carros container">
	<p>PREENCHA OS DADOS DO CARRO:</p>
	<form action="" method="POST" autocomplete="off">
		<div class="mostra-marca">
			<img src="img/marcas/api-carros-marcas-nenhuma.jpg" alt="Nenhum Logo">
		</div>
		<div class="mostra-campos">
			<label for="cadmarca">MARCA:</label>
			<select name="cadmarca" id="cadmarca" class="cad-campo">
				<option value="">Selecione a Marca</option>
				<?php foreach ($dataMJSON -> marcasJSON as $marca) : ?>
				<option value="<?php echo $marca->Marca; ?>" marca-id="<?php echo $marca->ID; ?>"><?php echo $marca->Marca; ?></option>	
				<?php endforeach; ?>
			</select>
			<label for="cadmodelo">MODELO:</label>
			<input type="text" name="cadmodelo" id="cadmodelo" class="cad-campo">
			<label for="cadano">ANO:</label>
			<input type="number" min="1885" max="2020" maxlength="4" name="cadano" id="cadano" class="cad-campo">

			<div class="btn-form">
				<span class="btn-cad">CADASTRAR</span>
				<span class="btn-clean">LIMPAR CAMPOS</span>
			</div>
		</div>
	</form>
</article>
