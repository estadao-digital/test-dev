 ...
 */
class Brand extends \Vehicle\Entity\Brand implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Vehicle\\Entity\\Brand' . "\0" . 'id', '' . "\0" . 'Vehicle\\Entity\\Brand' . "\0" . 'name', '' . "\0" . 'Vehicle\\Entity\\Brand' . "\0" . 'vehicles'];
        }
