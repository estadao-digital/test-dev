...
<body onload ="preparaAtualiza(<?php echo $id ?>);">
...
<form style="margin-top: 20px;" id="form" method="post">

       

<div class="form-group">
    <label>Id</label>
    <input type="number" id="id" class="form-control" value="<?php echo $id ?>" disabled >
...
<a style="margin-left:0;"  role="button" class="btn btn-primary btn"  onclick="atualizaVeiculo()">Atualizar</a>
</div>
