...
GlobalConfig::$CONNECTION_SETTING->DBName = "carros";
...
/** the root url of the application with trailing slash, for example http://localhost/cadastro de carros/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'carros/';
