...
function load_datatable($table, identifier, usersettings) {
    ...
    var table = $table.DataTable({
        ...
        "processing": true,
        "ajax": {
            "url": microservice_url + 'ms/dashboardmgo/confirm?CI_SUB_DOMAIN=' + $form.data('ci_sub_domain'),
            "type": "POST",
            "data": data_form,
            ...
            "complete": function (data) {
                ...
                if (data.error) {
                    error_ajax(table, $form, {error: [data.error]});
                } else {
            ...
            "statusCode": {
                401: function (data, textStatus, jqXHR) {
                    ...
                    error_ajax(table, $form, {error: [data]});
                }
            }
        },
