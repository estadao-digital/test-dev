$(function () {
    ...
    action_form("#bulkaction-template");
    action_form_filter("#form-template-filter");
});
...
function load_table() {
    var $table = $("table#table-template"),
        identifier = {
            reorder: "reorder-table-template",
            colvis: "colvis-table-template",
            colwidth: "colwidth-table-template"
        };
