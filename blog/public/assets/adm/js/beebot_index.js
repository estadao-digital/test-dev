...
function load_table() {
    var $table = $("table#table-beebot"),
        identifier = {
            reorder: "reorder-table-beebot",
            colvis: "colvis-table-beebot",
            colwidth: "colwidth-table-beebot"
        };
...
function delete_beebot(id) {
    var data = {id: id};
    $.post('ws/beebot/delete/' + id, data, function (data) {
        if (!data.error) {
            localMsg(data);
