...
function load_table() {
    var $table = $("table#table-store"),
        identifier = {
            reorder: "reorder-table-store",
            colvis: "colvis-table-store",
            colwidth: "colwidth-table-store"
        };
...
function delete_store(id) {
    var data = {id: id};
    $.post('ws/store/delete/' + id, data, function (data) {
        if (!data.error) {
            localMsg(data);
